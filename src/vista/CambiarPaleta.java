...
public class CambiarPaleta extends javax.swing.JFrame {
    ...
    public CambiarPaleta() {
        ...
        for(String paleta: listadoPaletas){
            cbb_paletas.addItem(paleta);
        }
    ...
    private void actualizarColoresDemo(){
        ...
        BackgroundDemo.setBackground(coloresDemo.getBackground());
        btn1demo.setBackground(coloresDemo.getMouseEnter());
        btn2demo.setBackground(coloresDemo.getPanel());
        btn3demo.setBackground(coloresDemo.getPanel());
        PanelIzqDemo.setBackground(coloresDemo.getPanel());
        BannerDemo.setBackground(coloresDemo.getPanel());
    }
