...
public class NuevaVenta extends javax.swing.JFrame {
    ...
    public NuevaVenta() {
        ...
        rb_edenred.setBackground(BackgroundColor);
        ...
        rb_edenred.setForeground(textColor);
    ...
    private void initComponents() {
        ...
        img_edenred = new javax.swing.JLabel();
        ...
        PanelTotal.add(lbl_metodoPago, new org.netbeans.lib.awtextra.AbsoluteConstraints(15, 195, 490, 40));
        ...
        PanelMetodoPago.add(rb_debito, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 140, 180, 40));
        ...
        PanelMetodoPago.add(rb_credito, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 240, 180, 40));
        ...
        PanelMetodoPago.add(img_debito, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 130, 50, 51));
        ...
        PanelMetodoPago.add(img_credito, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 240, 50, 37));
        ...
        PanelMetodoPago.add(rb_transferencia, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 340, 180, 40));

        img_transferencia.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/transferencia.png"))); // NOI18N
        PanelMetodoPago.add(img_transferencia, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 330, 50, -1));

        rb_edenred.setBackground(new java.awt.Color(230, 204, 178));
        rb_METODOPAGO.add(rb_edenred);
        rb_edenred.setFont(new java.awt.Font("Roboto", 0, 18)); // NOI18N
        ...
        PanelMetodoPago.add(rb_edenred, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 440, 180, 40));

        img_edenred.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/edenred_logo.png"))); // NOI18N
        PanelMetodoPago.add(img_edenred, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 430, 50, -1));
        ...
        PanelPaso2Layout.setVerticalGroup(
            PanelPaso2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(lbl_2, javax.swing.GroupLayout.DEFAULT_SIZE, 518, Short.MAX_VALUE)
        );
    ...
    private String seleccion(){
        ...
        else if(rb_edenred.isSelected()) return "EDENRED";       
